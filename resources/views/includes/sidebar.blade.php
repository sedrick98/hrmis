<div class="c-sidebar c-sidebar-dark c-sidebar-fixed c-sidebar-lg-show" id="sidebar">
    <div class="c-sidebar-brand d-lg-down-none">
        ...
        {{-- <i class="c-sidebar-brand-full" >
            <img src="{{url('img/dost_track_logo.png')}}" width="118" height="46" alt="">
        </i>
        <i class="c-sidebar-brand-minimized">
            <img src="{{url('img/dosticon.png')}}"width="46" height="46" alt="">
        </i> --}}
        {{-- <img class="c-sidebar-brand-full" src="{{url('img/dost_track_logo.png')}}" width="118" height="46" alt=""> --}}
        {{-- <img class="c-sidebar-brand-minimized" src="{{url('img/dosticon.png')}} "width="46" height="46" alt=""> --}}
        {{-- <h1>
            DOSTRACK
        </h1> --}}

        {{-- <svg class="c-sidebar-brand-full" width="118" height="46" alt="CoreUI Logo">
            <use xlink:href="{{url('img/dost_track_logo.svg')}}"></use>
        </svg>
        <svg class="c-sidebar-brand-minimized" width="46" height="46" alt="CoreUI Logo">
            <use xlink:href="img/dost_track_logo.svg#signet"></use>
        </svg> --}}
    </div>
    <ul class="c-sidebar-nav ps">
        <li class="c-sidebar-nav-item">
            <a class="c-sidebar-nav-link" href="{{url('dashboard')}}">
                ...
                {{-- <svg class="c-sidebar-nav-icon">
                    <use xlink:href="assets/coreui/free-cil/free.svg#cil-drop"></use>
                </svg>  --}}
        {{-- <i class="cib-when-i-work"></i>  --}}
        ...
        <li class="c-sidebar-nav-title">INTRA-OFFICE COMMUNICATION</li>
        <li class="c-sidebar-nav-item c-sidebar-nav-dropdown">
            {{-- <li class="c-sidebar-nav-item">
                <a class="c-sidebar-nav-link" href="colors.html">
                    <i class="c-sidebar-nav-icon cil-library-add"></i> My Documents
                </a>
            </li>
            <li class="c-sidebar-nav-item">
                <a class="c-sidebar-nav-link" href="colors.html">
            ...
            <li class="c-sidebar-nav-item">
                <a class="c-sidebar-nav-link" href="colors.html">
                    <i class="c-sidebar-nav-icon cil-map"></i> Routed Documents
                </a>
            </li> --}}
        </li>

        <li class="c-sidebar-nav-title">INCOMING DOCUMENTS</li>
        <li class="c-sidebar-nav-title">OUTGOING DOCUMENTS</li>
