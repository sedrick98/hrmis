          ...
          <div class="card-group">
            <div class="card p-4">
              <div class="card-body">
                ...
                <p>
                    <div class="text-danger font-weight-bold">{{session('err_msg')}}</div>
                </p>
                @endif
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <input class="form-control" type="text" placeholder="{{ __('Username') }}" name="username" value="{{ old('username') }}" required autofocus autocomplete="off">
                    </div>
